...
//        SortTestHelper.testSort("playwithalgorithm.03.MergeSort", arr1);

//        SortTestHelper.testSort("playwithalgorithm.03.QuickSort", arr2);
//        SortTestHelper.testSort("bobo.algo.QuickSort2Ways", arr3);
//        SortTestHelper.testSort("bobo.algo.QuickSort3Ways", arr4);
        SortTestHelper.testSort("playwithalgorithm.04.HeapSort1", arr5);
        SortTestHelper.testSort("playwithalgorithm.04.HeapSort2", arr6);
